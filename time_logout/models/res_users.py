...
class ResUsers(models.Model):
    ...
    context_session_alert_time = fields.Integer(string = 'Alert for Timeout', default=1785, help="Time in seconds before timeout to show the expire message (max 15s before)")
